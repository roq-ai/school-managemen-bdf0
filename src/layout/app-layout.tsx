...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'teacher', 'accountant', 'student', 'parent'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Teachers', path: '/teachers', entity: 'teacher', service: AccessServiceEnum.PROJECT, icon: FiBook },
