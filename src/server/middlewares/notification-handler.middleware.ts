...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'academic_year.create': {
    ...
    key: 'new-academic-year',
    tenantPath: ['organization', 'academic_year'],
    userPath: [],
  },
  'student.create': {
    roles: ['admin', 'teacher', 'accountant'],
    key: 'student-registration',
    tenantPath: ['organization', 'academic_year', 'student'],
    userPath: [],
  },
  'schedule.update': {
    roles: ['admin', 'teacher', 'student', 'parent'],
    key: 'class-schedule-update',
    tenantPath: ['organization', 'academic_year', 'student', 'schedule'],
    userPath: [],
  },
  'student.update': {
    roles: ['parent'],
    key: 'student-absence-alert',
    tenantPath: ['organization', 'academic_year', 'student'],
    userPath: [],
  },
  'organization.update': {
    roles: ['admin', 'teacher', 'student', 'parent'],
    key: 'new-circular-published',
    tenantPath: ['organization'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'teacher', 'accountant', 'student', 'parent'];
