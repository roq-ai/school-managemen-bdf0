...
import { ScheduleListPage } from 'pages/schedules';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('student', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/students/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Class" text={data?.class} />

                <FormListItem label="Section" text={data?.section} />

                <FormListItem label="Fees" text={data?.fees} />

                <FormListItem label="Transport Details" text={data?.transport_details} />
                ...
                {hasAccess('academic_year', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Academic Year"
                    text={
                      <Link as={NextLink} href={`/academic-years/view/${data?.academic_year?.id}`}>
