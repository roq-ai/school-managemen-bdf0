...
import { getAcademicYearById, updateAcademicYearById } from 'apiSdk/academic-years';
...
function AcademicYearEditPage() {
  ...
  const handleSubmit = async (values: AcademicYearInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateAcademicYearById(id, values);
      mutate(updated);
      resetForm();
