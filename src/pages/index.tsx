  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience comprehensive educational management with School Management. Ensuring accessibility for students, parents, teachers, and staff, we provide a holistic approach to academic administration. From scheduling to record-keeping, communication to transportation tracking, we've got every aspect covered. Stay connected, stay informed, and excel with School Management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzY2hvb2x8ZW58MHx8fHwxNjkzMzg2NDAwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box>
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Admin" type="admin" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
